...
kubectl set image deployments/client-deployment server=mgh1990/multi-client:$SHA
kubectl set image deployments/worker-deployment server=mgh1990/multi-worker:$SHA